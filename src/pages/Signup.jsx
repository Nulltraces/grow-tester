  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/auth/register`, {
        ...
        body: JSON.stringify({
          username, email, password, affiliateCode,
        }),
      });
    ...
    <form onSubmit={handleSubmit} className='dsd'>
      <div className='modal'>
        <div className='register'>
          ...
          <div className='text_start mt-4'>
            <label className='input_title' for="exampleInputEmail1">Password</label>
            <input
          ...
          <div className='mt-4 text_start'>
            <label className='input_title' for="exampleInputEmail1">Email</label>
            <input
              class="form-control css_input"
              type="email"
              placeholder="Email"
          ...
          <div className='mt-4 text_start'>
            <label className='input_title' for="exampleInputEmail1">Affiliate Code (Optional)</label>
            <input
              class="form-control css_input"
              type="text"
          ...
          <ReCAPTCHA theme='dark' style={{ background: "rgb(51, 51, 51)" }} className='custom mt-3'
            sitekey="6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI"
            onChange={onChange}
          />
          <button type='submit' className='register_btn mt-3'>Register</button>
          <p className='border_line'>Already have an account?<span className='sign_label'>Sign In</span></p>
        </div>
      </div>
    </form>
  );
