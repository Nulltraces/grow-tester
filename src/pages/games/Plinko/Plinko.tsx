            ...
            <div className="w-full h-full min-h-[500px] max-sm:min-h-[400px]">
              <div className="sc-12d9wi9-0 jFkvpw">
                <canvas
                  width="600"
                  height="450"
                  style={{ background: "0% 0% / contain transparent;" }}
                ></canvas>
              </div>
            </div>
          </div>
              ...
              <tbody className="border-spacing-y-3">
                <tr className="overflow-hidden text-sm bg-dark-800 text-light">
                  ...
                  <td className="text-left text-white overflow-hidden min-w-[130px]">
                    <a className="cursor-pointer">Kaankayacik1</a>
                  </td>
                ...
                <tr className="overflow-hidden text-sm bg-dark-800 text-light">
                  ...
                  <td className="text-left text-white overflow-hidden min-w-[130px]">
                    <a className="cursor-pointer">Geonsy</a>
                  </td>
                  <td className="text-center  min-w-[80px]">
                    <span className="flex items-center justify-center gap-1">
                      0.01
                ...
                <tr className="overflow-hidden text-sm bg-dark-800 text-light">
                  ...
                  <td className="text-left text-white overflow-hidden min-w-[130px]">
                    <a className="cursor-pointer">ogdaily</a>
                  </td>
                  <td className="text-center  min-w-[80px]">
                    <span className="flex items-center justify-center gap-1">
                      0.30
                ...
                <tr className="overflow-hidden text-sm bg-dark-800 text-light">
                  ...
                  <td className="text-left text-white overflow-hidden min-w-[130px]">
                    <a className="cursor-pointer">beratabidepo</a>
                  </td>
                  <td className="text-center  min-w-[80px]">
                    <span className="flex items-center justify-center gap-1">
                      0.10
                ...
                <tr className="overflow-hidden text-sm bg-dark-800 text-light">
                  ...
                  <td className="text-left text-white overflow-hidden min-w-[130px]">
                    <a className="cursor-pointer">ghostog66</a>
                  </td>
                  <td className="text-center  min-w-[80px]">
                    <span className="flex items-center justify-center gap-1">
                      0.10
                ...
                <tr className="overflow-hidden text-sm bg-dark-800 text-light">
                  ...
                  <td className="text-left text-white overflow-hidden min-w-[130px]">
                    <a className="cursor-pointer">taarakast</a>
                  </td>
                  <td className="text-center  min-w-[80px]">
                    <span className="flex items-center justify-center gap-1">
                      0.01
                ...
                <tr className="overflow-hidden text-sm bg-dark-800 text-light">
                  ...
                  <td className="text-left text-white overflow-hidden min-w-[130px]">
                    <a className="cursor-pointer">LGUG</a>
                  </td>
                  <td className="text-center  min-w-[80px]">
                    <span className="flex items-center justify-center gap-1">
                      0.10
                ...
                <tr className="overflow-hidden text-sm bg-dark-800 text-light">
                  ...
                  <td className="text-left text-white overflow-hidden min-w-[130px]">
                    <a className="cursor-pointer">Sakopatas</a>
                  </td>
                  <td className="text-center  min-w-[80px]">
                    <span className="flex items-center justify-center gap-1">
                      0.13
