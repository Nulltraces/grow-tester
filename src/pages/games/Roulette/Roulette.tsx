          ...
          <div className="overflow-hidden bg-dark-850 w-full h-full min-h-[400px] max-sm:min-h-[300px] flex justify-center relative">
            <div className="overflow-hidden">
              <div className="m-[1rem] overflow-hidden relative min-h-[460px] flex flex-col justify-center">
                ...
                <div className="flex w-full justify-center text-2xl absolute top-[20%]"></div>
                <div className="relative flex justify-center w-full m-auto overflow-hidden">
                  ...
                  >
                    <div className="flex flex-row w-full">
                      ...
                      <div className="bg-red-600 w-[75px] h-[75px] rounded-md m-[3px] roulette-shadow flex items-center justify-center">
                        <img
                          alt=""
                          src={Wrench}
                          draggable="false"
                  ...
                  <div className="absolute h-full w-[1px] right-[-1px] z-[2] shadow-dark-850 shadow-[1px_0_30px_60px_var(--tw-shadow)]"></div>
                </div>
              </div>
            </div>
          </div>
